				...
				<div class="col col-8 p-4 bg-light">
					<form action="action_edit.php" method="POST">
						...
						<div class="form-group mb-2">
							...
							<input name="nis" id="nis" value="<?=$nis?>" class="form-control" type="text" placeholder="Nomor Induk Siswa" required>
						</div>
						...
						<div class="form-group mb-2">
							...
							<div class="form-check disabled">
								...
								<?=$maleChecked?> type="radio" name="gender" id="female" value="P" required>
